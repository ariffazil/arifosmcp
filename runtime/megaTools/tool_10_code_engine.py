"""
arifosmcp/runtime/megaTools/10_code_engine.py

M-3_EXEC: System-level hygiene and observation
Stage: M-3_EXEC | Trinity: ALL | Floors: F1

Modes: fs, process, net, tail, replay
"""
